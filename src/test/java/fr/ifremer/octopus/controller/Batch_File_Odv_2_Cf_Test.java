 ...
 *
 */
public class Batch_File_Odv_2_Cf_Test extends AbstractBatch_X_2_Y_Test {
	private static final Logger logger = LogManager.getLogger(Batch_File_Odv_2_Cf_Test.class);
